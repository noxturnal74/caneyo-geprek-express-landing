...
if (!js.includes("requestAnimationFrame") || !js.includes('motionProfile = "geprek"') || !html.includes('data-motion-profile="geprek"')) {
...
console.log("Caneyo Geprek Express brand-DNA build check passed.");
